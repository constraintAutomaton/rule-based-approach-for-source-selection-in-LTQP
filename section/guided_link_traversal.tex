...
The query engine will always follow \texttt{ex:nextNode} from expressions following the schema "\texttt{ex:currentNode tree:node ex:nextNode}" regardless of the constraints.
}

Most research on LTQP centered around query execution in Linked Open Data environments.
