...
It will always follow  \texttt{ex:nextNode} from expressions following the schema "\texttt{ex:currentNode tree:node ex:nextNode}" regardless of the constraints.
}
