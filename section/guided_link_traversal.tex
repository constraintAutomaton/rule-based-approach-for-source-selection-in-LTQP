...
Our approach builds upon the concept of structural assumptions~\cite{taelman2023} to exploit the structural properties of TREE annotated datasets to prune irrelevant links.
...
\begin{table}[ht]
    ...
    The rule-based (-rule) criterion performs better with a larger number of fragments.
