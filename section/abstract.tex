...
% <!-- task -->
We propose to use a rule-based reachability criterion that capture logical expressions expressed in hypermedia descriptions within linked data documents to define the source selection policy of traversal queries.
%<!-- object -->
