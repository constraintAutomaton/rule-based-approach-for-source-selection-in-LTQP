...
For example, the traversal of documents considering expressions such as data produced after the first of September are stored at \texttt{ex:afterFirstSeptember} is difficult to express using current criteria.
% <!-- task -->
We propose to use a rule-based reachability criterion that capture logical expressions expressed in hypermedia descriptions of linked data documents to define completeness and source selection of traversal queries.
%<!-- object -->
...
% <!-- conclusion -->
Given the promising result of this initial approach, we will extend our implementation beyond a time-based criterion, to support general reasoning over linked data in the source selection process during traversal queries.
\end{abstract}
