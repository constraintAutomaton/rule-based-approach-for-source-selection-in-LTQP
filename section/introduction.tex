...
The subweb specifications~\cite{bogaerts_rulemlrr_2021}, propose to allow the data provider to define the traversal path in regards to information related to them.
