...
The subweb specifications language (SWSL)~\cite{bogaerts_rulemlrr_2021}, allows the data provider to define traversal paths concerning the information related to them.
